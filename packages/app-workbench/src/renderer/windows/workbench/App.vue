...
import WorkbenchGrid from './components/grid/index.vue'
import WorkbenchHeader from './components/header/index.vue'
import WorkbenchTabs from './components/tabs/index.vue'
import WorkbenchViewer from './components/viewer/index.vue'
import { useWorkbenchStore } from './store/workbench/workbench'
