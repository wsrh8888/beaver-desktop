 ...
 * 主进程通知渲染进程
 *
 * 注：本文件为 app-moment 自包含副本，去除了对 @beaver-im/app-circle 的耦合
 * （DATABASE_CIRCLE 通道由 app-circle 自身维护，moment 不消费该通道）。
 */
 ...
 * 主进程更新通知渲染进程
 *
 * 注：DATABASE_CIRCLE 通道的命令类型由 app-circle 自身维护，
 * moment 不消费该通道，故此处不引入 app-circle 依赖。
 */
