...
<script lang="ts">
import type { ICircleCommentItem, ICirclePostItem, ICirclePostLikeItem, IGetPostDetailRes } from '../../../../../../../common/type/ajax/circle'
...
import MomentContentCard from '@beaver-im/beaver-biz/momentContentCard/index.vue'
