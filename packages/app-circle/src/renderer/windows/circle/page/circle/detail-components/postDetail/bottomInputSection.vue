      ...
      <div class="input-container">
        ...
        <div class="input-actions">
          <button class="send-btn" :disabled="!commentText.trim()" @click="handleSendComment">
            <img src="@beaver-im/app-circle/renderer/assets/image/moment/send.svg" alt="发送" class="send-icon">
          </button>
        </div>
      </div>
    </div>
...
<script lang="ts">
import SvgLikeActive from '@beaver-im/app-circle/renderer/assets/image/moment/like-active.svg'
import SvgLike from '@beaver-im/app-circle/renderer/assets/image/moment/like-default.svg'
