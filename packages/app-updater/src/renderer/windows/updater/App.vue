...
<template>
  <div class="update-window">
    ...
    <div class="update-header">
      <div class="app-icon">
        <img :src="logoImg" alt="Beaver Logo">
      </div>
...
<script lang="ts">
import { NotificationModule } from '../../../common/type/preload/notification'
...
import downloadIcon from '../../assets/image/update/download.svg'
import restartIcon from '../../assets/image/update/restart.svg'
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleNotification = (payload: any) => {
      if (payload.command === 'updateUpdater' && payload.data) {
